...
const ShopByChoice = () => {
    return (
        <div className='mx-3 lg:mx-auto container my-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center justify-center gap-12'>
                {/* office collection */}
                <div className='px-4 flex items-center justify-center gap-4 bg-gray-50 h-[300px] rounded-md shadow-md cursor-pointer hover:scale-105 transition-all duration-300'>
                    <div>
